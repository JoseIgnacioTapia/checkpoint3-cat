...
describe('---------- `deleteAccessory` y `modifyAccessory` ----------', function () {
  ...
  it('deleteAccessory: elimina un accesorio del array y devuelve un mensaje', function () {
    controller.addAccessory({ id: 3, color: 'Red', type: 'Necklace', description: 'Golden Necklace'})
    controller.addAccessory({ id: 4, color: 'Black', type: 'Bun', description: 'Black Bun'})
  ...
  it('modifyAccessory: modifica el accesorio y lo devuelve', function () {
    ...
    controller.addAccessory({ id: 3, color: 'Red', type: 'Necklace', description: 'Golden Necklace'})
    controller.addAccessory({ id: 4, color: 'Black', type: 'Bun', description: 'Black bun'})
    controller.addAccessory({ id: 5, color: 'White', type: 'Necklace', description: 'Cloudy Necklace'})
    expect(JSON.stringify(controller.modifyAccessory(changes))).to.eql(JSON.stringify(controller.getAccessories()[0]))
  })
  ...
  it('modifyAccessory: modifica el accesorio parcialmente y lo devuelve', function () {
    ...
    expect(accesoryBeforeUpdate.description).eq(accesoryAfterUpdate.description);
  })
})
