...
describe('---------- `addCatAccessory` ----------', function () {
  ...
  it('Agrega el accesorio a cualquier felin@', function () {
    ...
    expect(controller.addCatAccessory('Fifix', awesomeAccessory.id)).to.eql('El accesorio Bun fue agregado a Fifix con exito')
  ...
  it('Si el gato ya tiene el accesorio, devuelve un error', function () {
    ...
    expect(() => controller.addCatAccessory('Fifix', premiumAccessory.id)).to.throw('El gato Fifix ya tiene el accesorio puesto')
